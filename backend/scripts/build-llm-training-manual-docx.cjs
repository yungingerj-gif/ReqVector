/**
 * Generates docs/llm-training-manual.docx from docs/llm-training-manual.md.
 * Run: npm --workspace backend run docx:llm-training-manual
 */
const fs = require("fs");
...
const MD_PATH = path.join(REPO_ROOT, "docs", "llm-training-manual.md");
const OUT_PATH = path.join(REPO_ROOT, "docs", "llm-training-manual.docx");
        ...
        children: [
          new Paragraph({
            children: [
              new TextRun({
                text:
                  "Generated from llm-training-manual.md — regenerate via npm --workspace backend run docx:llm-training-manual",
                italics: true,
                size: 18,
              }),
            ],
