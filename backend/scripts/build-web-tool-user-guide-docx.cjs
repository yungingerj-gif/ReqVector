/**
 * Generates docs/web-tool-user-guide.docx from docs/web-tool-user-guide.md.
 * Run: npm --workspace backend run docx:web-tool-user-guide
 */
const fs = require("fs");
...
const MD_PATH = path.join(REPO_ROOT, "docs", "web-tool-user-guide.md");
const OUT_PATH = path.join(REPO_ROOT, "docs", "web-tool-user-guide.docx");
        ...
        children: [
          new Paragraph({
            children: [
              new TextRun({
                text:
                  "Generated from web-tool-user-guide.md — regenerate via npm --workspace backend run docx:web-tool-user-guide",
                italics: true,
                size: 18,
              }),
            ],
